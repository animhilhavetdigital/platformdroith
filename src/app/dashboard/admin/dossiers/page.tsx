...
export default function AdminDossiersPage({ searchParams }: Props) {
  ...
  return (
    <DashboardLayout allowedRoles={['super_admin']}>
      <div className="space-y-6">
        ...
        {isPreview && previewData ? (
          <DossiersContent data={previewData} scenario={previewScenario} />
        ) : (
          <div className="rounded-2xl border border-gray-200 bg-white p-12 text-center shadow-sm">
            <p className="text-gray-500">Liste des dossiers en cours de developpement.</p>
          </div>
        )}
      </div>
    </DashboardLayout>
