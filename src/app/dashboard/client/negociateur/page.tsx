    ...
    <DashboardLayout allowedRoles={['client']}>
      <div className="mx-auto max-w-7xl space-y-8">
        ...
        <div>
          ...
          <p className="mt-1 text-gray-500">Suivez l&apos;intervention de votre négociateur et accédez au rapport final.</p>
        </div>
        ...
        {isActive && (
          <div className="rounded-2xl border border-success-100 bg-success-50/40 p-8 text-center space-y-4">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              Un négociateur expérimenté est désormais en charge de votre dossier. Il contacte directement l&apos;organisme de crédit pour obtenir un accord amiable.
            </p>
              ...
              <div className="mx-auto max-w-md rounded-2xl border border-success-200 bg-white p-5 text-left">
                ...
                <ul className="mt-4 space-y-2">
                  {mediationEtapes.map((etape: any) => (
                    <li key={etape.id} className="flex items-center gap-2 text-sm text-gray-700">
                      {etape.complete ? (
        ...
        {isDone && (
          <div className="space-y-6">
            <div className="rounded-2xl border border-success-100 bg-success-50/40 p-8 text-center space-y-4">
              ...
              <p className="text-gray-600 max-w-md mx-auto">
                Votre négociateur a finalisé le dossier. Vous trouverez ci-dessous le résultat de la négociation et le rapport final.
              </p>
            </div>
